...
//         </CardHeader>
//         <Form {...form}>
//           {/* el onSubmit de abajo es inventao. el valor es isSubmitting */}
...
//                               : undefined
//                           }
//                           onSelect={(newDate: DateRange | Date | undefined) => {
//                             if (isRange) {
//                               setDate(newDate as DateRange);
//                               field.onChange(newDate ? (newDate as DateRange).from?.toISOString() : undefined);
//                             } else {
//                               field.onChange(newDate ? (newDate as Date).toISOString() : undefined);
//                             }
//                           }}
//                           }}
//                           numberOfMonths={2}
