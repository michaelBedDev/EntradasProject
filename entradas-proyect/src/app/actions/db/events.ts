...
// export async function getEventosWithOrganizers(): Promise<Evento[]> {
...
//  */
// export async function getEventosByOrganizador(): Promise<Evento[]> {
...
// export async function getEventosByName(query?: string): Promise<Evento[]> {
//   const supabase = await getSupabaseServerClient();
...
// export async function getEventById(id: string): Promise<Evento> {
//   const supabase = await getSupabaseServerClient();
...
//   payload: Omit<EventInit, "id" | "created_at" | "status">,
// ): Promise<Evento> {
//   const supabase = await getSupabaseServerClient();
