...
- Software necesario (S.O. válidos, software externo co que se comunica a nosa aplicación, etc.).
...
- Indicar se será necesario formar as persoas usuarias. En caso afirmativo, planificar.
- Manual de uso, FAQ ou outro xeito que sexa o máis adecuado para que as persoas usuarias saiban usar a aplicación informática.

## Melloras futuras

Inclúe neste apartado as posibilidades de mellora da aplicación no futuro.
